...
#   clipr::write_clip(unname(as.matrix(simulated_data_df)))
  ...
  #   "04 MDM Neuro-Fundraising Lab", "00 Jobs", "2024",
  #   "SDZ_BC__Quarterly Survey_Wave_2", "Data Collection", "survey_monkey_data",
  #   "Donor", "w02_02_2024", "simulated_data", "w02_02_2024_survey_monkey_design_form.xlsx"
  # )
  #
  # # Create the simulated data
  # donor_simulated_data_df <- simulate_data_from_sm_design_form(
  #   sm_design_form_path = donor_sm_design_form_path,
  #   desired_sample_size = 2000,
  #   name_of_form = "Design Form",
  #   name_of_logic = "Logic",
  #   names_of_others_to_ignore = c("IGNORE")
  ...
  #
  # # Write it to the clipboard
  # clipr::write_clip(unname(as.matrix(donor_simulated_data_df)))
  #
  # #
  # #
  # #
